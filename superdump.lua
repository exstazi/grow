...
showBtn.Size = UDim2.new(0.3, 0, 0.06, 0)
showBtn.Position = UDim2.new(0.35, 0, 0.05, 0)
showBtn.BackgroundColor3 = Color3.fromRGB(60, 60, 60)
showBtn.TextColor3 = Color3.new(1, 1, 1)
showBtn.TextScaled = true
showBtn.Font = Enum.Font.SourceSansBold
showBtn.Text = "📂 VISA FIL"

local toggleBtn = Instance.new("TextButton", gui)
toggleBtn.Size = UDim2.new(0.25, 0, 0.06, 0)
...
showBtn.MouseButton1Click:Connect(function()
    if readfile then
        ...
        box.Text = "[⚠️] readfile saknas i denna executor."
    end
end)
